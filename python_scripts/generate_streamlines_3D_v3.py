...
DefineScalarExpression("By", "conn_cmfe(</datarepo/forashok/By.file_* database[0]id:GIRAFFE--By>, <Carpet AMR-grid>)")
DefineScalarExpression("Bz", "conn_cmfe(</datarepo/forashok/Bz.file_* database[0]id:GIRAFFE--Bz>, <Carpet AMR-grid>)")
