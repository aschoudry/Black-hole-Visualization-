...
particle_data = '/datarepo/forashok/zero_Degrees_Rotation/particles.txt'
...
Seed = np.loadtxt(particle_data, skiprows = 2, unpack = True)
...
def Moving_seeds_around_BBH(BH_x, BH_y, BH_z, BH_radius, Seed_list): 
	...
	inner_radius_for_seeds = 0 *BH_radius
...
#time_index = 30
	...
	Particles_around_BH1 = Moving_seeds_around_BBH(BH1_centre_x[BH_frequency], BH1_centre_y[BH_frequency], BH1_centre_z[BH_frequency], 2.5, Seed[1:-1,time_index])
	Particles_around_BH2 = Moving_seeds_around_BBH(BH2_centre_x[BH_frequency], BH2_centre_y[BH_frequency], BH2_centre_z[BH_frequency], 2.5, Seed[1:-1,time_index])
	...
	SaveWindowAtts.outputDirectory = "/home/aschoudhary/Streamline_project/plots/side_view_movingSeeds_v1"
